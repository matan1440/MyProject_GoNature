...
/**
 * This Class is for MenuVisitorWithOrderController The class contains methods
 * for the menu Navigation + initialize the clock
 * 
 * @author Omer
 */
public class MenuVisitorWithOrderController implements Initializable {
